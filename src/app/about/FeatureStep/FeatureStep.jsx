...
export default function FeatureSteps() {
  ...
  return (
    <section className=" bg-[#F2F4F7] py-16">
        <div className="text-center mt-7 mb-15 mx-auto container px-4">
      ...
      <div className="lg:px-12 px-6 container mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
        {steps.map((item, i) => (
