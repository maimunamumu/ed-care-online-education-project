...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0e2625] text-white pt-20 pb-10 px-6 md:px-16">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 cursor-pointer">
              <Image src="/assets/footer-post-1.png" alt="post1" width={70} height={70} className="rounded-lg object-cover" />
              <div>
            ...
            {/* POST 2 */}
            <div className="flex items-center gap-4 cursor-pointer">
              <Image src="/assets/footer-post-2.png" alt="post2" width={70} height={70} className="rounded-lg object-cover" />
              <div>
                <p className="font-semibold hover:text-white">Where Dreams Find A Home</p>
                <div className="flex items-center text-gray-400 text-sm gap-2">
                  <CalendarDays size={15} />
